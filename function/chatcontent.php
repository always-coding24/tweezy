...
include "function/time.php";

?>
<?php
//fetching the user info except password

$stmt = $mysqli->prepare("SELECT `id`, `username`,  `email`, `image`, `phone`, `gender`, `typing_to`, `status`  FROM users WHERE id = ?");
$stmt->bind_param("s", $_SESSION['user_id']);
$stmt->execute();
$stmt->bind_result($user_id, $user_name, $email, $user_avatar, $phone, $gender, $typing_to, $status);
$stmt->fetch();
...
<div class="layout overflow-hidden">
            ...
            <li class="nav-item">
                <a class="nav-link active py-0 py-lg-8" id="tab-chats" href="#tab-content-chats" title="Chats" data-bs-toggle="tab" role="tab">
                    <div class="icon icon-xl icon-badged">
                        ...
                        <div id="unread" class="badge  badge-circle bg-primary">
                            <span></span>
                        </div>
                    </div>
                </a>
    ...
    <aside class="sidebar bg-light">
        <div class="tab-content h-100" role="tablist">
                ...
                <div class="d-flex flex-column h-100">
                    <div class="hide-scrollbar">
                        <div class="container py-8">
                            ...
                            <div class="mb-6">
                                <form action="#">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="friend_search" class="form-control form-control-lg ps-0" placeholder="Search users" aria-label="Search for  users...">
                                    </div>
                                </form>
                            ...
                            <!-- List -->
                            <div id="friends" class="card-list">
                ...
                <div class="d-flex flex-column h-100 position-relative">
                    <div class="hide-scrollbar">
                        ...
                        <div class="container py-8">
                            <!-- Title -->
                            <div class="mb-8">
                                <h2 class="fw-bold m-0">TWEEZY</h2>
                            </div>
                            ...
                            <div class="mb-6">
                                <form action="#">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control search form-control-lg ps-0" placeholder="Search messages or users" aria-label="Search for messages or users...">
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="card-list">
                                                ...
                                                <div class="row gx-5">
                                                    ...
                                                    <div class="col">
                                                        <div class="d-flex align-items-center mb-3">
                                                            <h5 class="me-auto mb-0">favour</h5>
                                ...
                                <!-- Card -->
                                <div onclick="cl('#tab-friends') " class="fab" style="position: absolute;top: 550px;right: 50px;background-color: #2787f5;color: #fff;border-radius: 0.6rem;padding: .9rem 1rem;font-size: large;"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus">
                                        <line x1="12" y1="5" x2="12" y2="19"></line>
                                        <line x1="5" y1="12" x2="19" y2="12"></line>
                                    </svg></div>
                                <!-- Card -->
            ...
            <!-- Settings -->
            <div class="tab-pane position-relative fade h-100" id="tab-content-settings" role="tabpanel">
                <div class="d-flex flex-column h-100">
                    <div class="hide-scrollbar">
                        <div class="container py-8">
                            ...
                            <div id="opt" class="offcanvas h-100 offcanvas-bottom position-absolute" aria-hidden="true"  >
                        ...
                        <div class=" overflow-hidden text-center">
                            <h5 class="text-truncate">Switch Your Account</h5>
...
<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-flag"><path d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"></path><line x1="4" y1="22" x2="4" y2="15"></line></svg>
                                        </div>
                                    </a>
                                </li>
                            </ul>
                                    ...
                                    <div class="row align-items-center gx-5">
                                        <div class="col-auto">
                                            <div class="avatar">
                                                ...
                                                <form action="function/settings.php?f=profile" id="profile" method="post">
                                                    <input onchange="profile(this)" id="upload-profile-photo" class="d-none" name="profile" type="file">
                                                </form>
                                        ...
                                        <div class="col">
                                            <h5><?= $user_name ?></h5>
                                            <p  class="text-truncate line-clamp me-auto" ><?= $email ?></p>
                                        </div>
                                        <div class="col-auto">
                                        ...
                                        <div class="col-auto">
                                            <a href="#" class="text-muted"  type="button" data-bs-toggle="offcanvas" data-bs-target="#opt">
                                                <div class="icon">
                                        ...
                                        <div class="accordion accordion-flush" id="accordion-profile">
                                            <div class="accordion-item">
                                                ...
                                                <div id="accordion-profile-body-1" class="accordion-collapse collapse" aria-labelledby="accordion-profile-1" data-parent="#accordion-profile">
                                                    <form method="post" action="function/settings.php?f=profileinfo" class="accordion-body">
                                                        ...
                                                        <div class="form-floating mb-6">
                                                            <input type="email" class="form-control" id="profile-email" name="email" placeholder="Email address">
                                                        ...
                                                        <div class="form-floating mb-6">
                                                            <textarea class="form-control" placeholder="Bio" id="profile-bio" name="bio" data-autosize="true" style="min-height: 120px;"></textarea>
                                                            <label for="profile-bio">Bio</label>
                                                        </div>

                                                        <button type="submit" name="profile-info" value="submited" class="btn btn-block btn-lg btn-primary w-100">Save</button>
                                                    </form>
                                                </div>
                                            </div>
    ...
    <audio id="sound" src="assets/sound/pop.mp3"></audio>

    <!-- Sidebar -->
    <?php
    //fetching the id of user info except password
    ...
    if (isset($_GET["id"])) {
        ...
        if (is_numeric($_GET["id"])) {
            ...
            $friend = $pdo->prepare("SELECT  `username`,  `email`, `image`, `phone`, `gender`, `bio`,  `status`  FROM users WHERE id = ? ");
            $friend->execute([$_GET["id"]]);
            $friend_info = $friend->fetchAll();
            // print_r($friend_info);
            if (!empty($friend_info)) {
                foreach ($friend_info as $row) {
                    # code...
                ...
                <main class="main is-visible" data-dropzone-area="">
                    <div class="container h-100">
                        ...
                        <div class="d-flex flex-column h-100 position-relative">
                                        ...
                                        <div class="row align-items-center text-center text-xl-start">
                                            ...
                                            <div class="col-12 col-xl-6">
                                                <div class="row align-items-center gx-5">
                                                    <div class="col-auto">
                                                        <!-- //todo -->
                                                        <div class="avatar getstatus  d-xl-inline-block">
                                                            <?php
                                                            if (!empty($friend_image)) {
                                                                echo "<img src='assets/img/avatars/$friend_image' alt='#' class='avatar-img'>";
                                                            } else {
                                                                $avatar_text = strtoupper($friend_username[0]);
                                                                echo "<span class='avatar-text'>{$avatar_text}</span>";
                                                            } ?>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col overflow-hidden">
                                                        <h5 class="text-truncate"><?= $friend_username ?></h5>
                                                        <!-- //todo -->
                                                        <p id="typingstatus" class="text-truncate">
                                                        ...
                                                        <div class="avatar-group">
                                                            <a href="#" class="avatar avatar-sm" data-bs-toggle="modal" data-bs-target="#modal-user-profile">
                                                                ...
                                                                if (!empty($friend_image)) {
                                                                    ...
                                                                    $avatar_text = strtoupper($friend_username[0] . $friend_username[1]);
                                                                    echo "<span class='avatar-text'>{$avatar_text}</span>";
                                                                } ?>
                                                            </a>
                            ...
                            <!-- Chat: Content -->
                            <div on class="chat-body hide-scrollbar flex-1 h-100 ">
                                <div class="chat-body-inner chat-logs " style="margin-bottom: 130px;">
                            ...
                            <div class="chat-footer pb-3 pb-lg-7 position-absolute bottom-0 start-0">
                                ...
                                <form class="chat-form rounded-pill bg-dark" data-emoji-form="">
                                    <div class="row align-items-center gx-0">
                                        ...
                                        <div class="col">
                                            <div class="input-group">
                                                <textarea class="form-control px-0" id="message" style="max-height: 100px; resize: none" placeholder="Type your message..." rows="1" data-emoji-input="" data-autosize="true"></textarea>
                                        ...
                                        <div class="col-auto">
                                            <button class="btn btn-icon btn-primary send-btn rounded-circle ms-5" type="submit" disabled="">
                    ...
                    <div class="offcanvas-header py-4 py-lg-7 border-bottom">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="chat.php" class="dropdown-item d-flex align-items-center text-danger">
                                        Leave
                                        <div class="icon ms-auto">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-out">
                                                <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path>
                    ...
                    <div class="offcanvas-body hide-scrollbar">
                        ...
                        <div class="tab-content py-2" role="tablist">
                            ...
                            <div class="tab-pane fade show active" id="offcanvas-tab-profile" role="tabpanel">
                                ...
                                <ul class="list-group list-group-flush border-top mt-8">
                                    <li data-bs-dismiss="offcanvas" onclick="$('#message').focus()" class="list-group-item">
            ...
            <div class="modal-body py-0">
                ...
                <div class="profile modal-gx-n">
                    ...
                    <div class="profile-body">
                        ...
                        <h4 class="mb-1"><?= $friend_username ?></h4>
                        <p></p>
                    </div>
                </div>
                <!-- H+eader -->
